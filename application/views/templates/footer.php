      ...
      <div class="row mt-3">
        ...
        <div class="col-md-3 col-lg-4 col-xl-3 mx-auto mb-4">
          ...
          <h6 class="text-uppercase fw-bold mb-4">
            <i class="fas fa-gem me-3"></i>MediTect Disclaimer
          </h6>
          <p>
          The information provided on MediTect is for general informational 
        ...
        <div class="col-md-2 col-lg-2 col-xl-2 mx-auto mb-4">
          <!-- Links -->
          <p>
          Under no circumstance shall we have any liability to you for damage 
          of any kind incurred as a result of reliance on any information 
          provided. Your use of the site and your reliance 
        ...
        <div class="col-md-4 col-lg-3 col-xl-3 mx-auto mb-md-0 mb-4">
          <!-- Links -->
          <h6 class="text-uppercase fw-bold mb-4">
            Makati Emergency Rescue Operations Hotline
          </h6>
          <p><i class="fas fa-phone me-3"></i> 168 / 8236-5790 </p>
          <h6 class="text-uppercase fw-bold mb-4">
            Makati COVID-19 Hotline
          </h6>
