              ...
              <div class="card mb-5">
                ...
                ?>                
                      ...
                      <?php
                        if(!empty($meditect_client) and !empty($meditect_client[0])){
                          if (!empty($meditect_client[0]['user_first_name']) and $meditect_client[0]['user_first_name'] != '') {
                            echo'
                              <input type="text" class="form-control" name = "user_first_name" value="'.$meditect_client[0]['user_first_name'].'" required>
                            ';        
                          } else {
                            echo'
                      ...
                      <?php
                        if(!empty($meditect_client) and !empty($meditect_client[0])){
                          if (!empty($meditect_client[0]['user_last_name']) and $meditect_client[0]['user_last_name'] != '') {
                            echo'
                              <input type="text" class="form-control" name = "user_last_name" value="'.$meditect_client[0]['user_last_name'].'" required>
                            ';  
                          } else {
                            echo'
                  ...
                  <div class="col-12">
                    ...
                    <input class="form-control p-1" name="profile_picture" type="file" id="formFile" value="John">
                  </div>
